...
export default async function handler(
  ...
  if (req.method === 'POST') {
    ...
    if (
      ...
      return res.status(400).json({
        errorMessage: 'Restaurant is not at that time',
      });
    }
...
// http://localhost:3000/api/restaurant/vivaan-fine-indian-cuisine-ottawa/reserve?day=1970-01-01&time=14:00:00.000Z&partySize=8
